...
<div id="shopping_cart_show">
<h1 id="cart_title" class="nadpis">{l s='1. Shopping cart summary'}<p><span id="summary_products_quantity">{$productNumber} {if $productNumber == 1}{l s='product'}{elseif $productNumber > 1 & $productNumber < 5}{l s='productss'}{else}{l s='products'}{/if}</span> <span id="" class="big total_price">{displayPrice price=$total_price}</span></p></h1>
...
{else}
	...
	{if isset($smarty.get.isPaymentStep) && $smarty.get.isPaymentStep}
	var isback=true;
	{else}
	var isback=false;
	{/if}
